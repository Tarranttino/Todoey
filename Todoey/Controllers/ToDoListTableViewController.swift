...
//                navBar.largeTitleTextAttributes = [NSAttributedString.foregroundColor : ContrastColorOf(navBarColour, returnFlat: true)]
            }
    ...
    @IBAction func addButtonPressed(_ sender: UIBarButtonItem) {
        ...
        let action = UIAlertAction(title: "Add Item", style: .default) { (action) in
            //what will happen once the user clicks the Add Item buttin on our UIAlert
    ...
    override func updateModel(at indexPath: IndexPath) {
        if let itemForDeleting = todoItems?[indexPath.row] {
            do {
                ...
                print("Error in delete item, \(error)")
            }
        }
    }
}
